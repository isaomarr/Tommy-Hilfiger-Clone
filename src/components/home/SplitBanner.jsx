...
import newArrivalsImg from '../../assets/images/04_HP_Tile03_dt.jpg'
import saleImg from '../../assets/images/04_HP_Tile04_dt.jpg'

const panels = [
  { title: 'New Arrivals', cta: 'Shop Now', to: '/new-arrivals', image: newArrivalsImg },
  { title: 'Sale', cta: 'Shop Sale', to: '/sale', image: saleImg },
]
